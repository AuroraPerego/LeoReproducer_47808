...
#include "DataFormats/SoATemplate/interface/reflex.h"
...
#define _DEFINE_METADATA_MEMBERS_IMPL(VALUE_TYPE, CPP_TYPE, NAME)                                                      \
  _SWITCH_ON_TYPE(VALUE_TYPE,                                                                                          \
      ...
      BOOST_PP_CAT(ParametersTypeOf_, NAME)::ConstType BOOST_PP_CAT(parametersOf_, NAME)() const {                                \
        return typename BOOST_PP_CAT(ParametersTypeOf_, NAME)::ConstType (&parent_.BOOST_PP_CAT(NAME, Span_));      \
      }                                                                                                                \
      SOA_HOST_DEVICE SOA_INLINE                                                                                       \
      ...
      SOA_HOST_DEVICE SOA_INLINE                                                                                       \
      BOOST_PP_CAT(ParametersTypeOf_, NAME)::ConstType BOOST_PP_CAT(parametersOf_, NAME)() const {                                \
        return typename BOOST_PP_CAT(ParametersTypeOf_, NAME)::ConstType (                                                                 \
